...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "FAQ", to: "/faq" },
      { label: "What is an RFP?", to: "/resources/what-is-an-rfp" },
      { label: "RFP examples", to: "/resources/rfp-examples" },
      { label: "RFP response template", to: "/resources/rfp-response-template" },
