...
export function ProjectContent({ project }: ProjectContentProps) {
    ...
    const checkFeatureAccess = () => {
      ...
      switch (activeSection) {
        ...
        case "evaluation":
          ...
          break;
        case "auto-proposal":
          requiredFeature = "auto_proposal_generation";
          break;
        default:
          return;
      }
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "auto-proposal":
        if (hasFeature("auto_proposal_generation")) {
          return (
            <ErrorBoundary>
              <Suspense fallback={<SectionLoading />}>
          ...
          return <FeatureLocked featureName="Auto-Generated Proposal" planName={getPlanName("auto_proposal_generation")} />;
        }
