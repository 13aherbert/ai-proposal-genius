                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="mt-8 pt-4 text-center border-t text-[10pt] italic text-foreground/40 flex items-center justify-center gap-2">
                            <img src={OPTIRFP_LOGO_PATH} alt="OptiRFP" className="h-4 w-auto opacity-60" />
                            <span>{WATERMARK_PHRASE}</span>
                          </div>
                        </TooltipTrigger>
                        <TooltipContent>
