 ...
 * Removes characters that could break CSS context or inject malicious styles.
 */
...
/**
 * Sanitizes CSS selectors/keys to only allow safe characters.
...
${colorConfig
  .map(([key, itemConfig]) => {
    const color =
      ...
      itemConfig.color
    // Sanitize both key and color value to prevent CSS injection
