...
<body>
${bodyHtml}
${plan === 'starter' ? '<div style="position:fixed;bottom:0;left:0;right:0;text-align:center;padding:8px;background:#f8f8f8;border-top:1px solid #e0e0e0;font-size:11px;color:#888;font-family:sans-serif;">Generated by OptiRFP Free — Upgrade to remove</div>' : ''}
</body>
</html>`;
